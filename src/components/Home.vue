...
<div style="background-color: #99a9bf">
  ...
  <el-row :gutter="20" background-color="#99a9bf">
    <el-col :span="14"><div class="grid-content bg-purple-dark" style="margin-left: 60px;">
      <el-table
        :data="tableData"
        style="width: 100%; border: solid 3px black;border-radius: 20px;box-shadow: 15px 10px 5px black;"
        height="550"
      >
        <el-table-column
          prop="jobid"
    ...
    <el-col :span="8"><div class="grid-content bg-purple-light"style="margin-right: 40px; border: solid 3px black;box-shadow: -10px 0px 5px black;">
      <el-alert
        ...
        :closable="false">
          ...
          <el-form :model="form" style="margin: 0px">
            <el-form-item label="主机数量" :label-width="formLabelWidth" >
              <el-input size="small" v-model="form.hostnum" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="边缘交换机端口数" :label-width="formLabelWidth" >
              <el-input size="small" v-model="form.edgeports" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="边缘交换机传输带宽" :label-width="formLabelWidth">
              <el-input size="small" v-model="form.edgebw" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="核心交换机端口数" :label-width="formLabelWidth">
              <el-input size="small" v-model="form.coreports" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="核心交换机传输带宽" :label-width="formLabelWidth">
              <el-input size="small" v-model="form.corebw" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item>
